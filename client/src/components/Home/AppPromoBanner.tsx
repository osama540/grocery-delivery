...
const AppPromoBanner = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
            <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    <button className="px-6 py-3 bg-white text-green-950 font-semibold rounded-cl hover:bg-orange-100">App Store</button>
                ...
                <img src={assets.delivery_truck} alt="Delivery Truck" className="mx-w-60 sm:max-w-120 xl:pr-10" />
        </div>  
    </section>
  )
}
