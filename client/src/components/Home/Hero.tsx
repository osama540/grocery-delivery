        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div className="max-w-xl xl:pl-10">
                ...
                <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">
                    ...
                    className="text-orange-300">Earth's-finesh</span> 
                </h1>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    hover:bg-orange-500 transition-all flex-center gap-2 active:scale-[0.98]"> Shop Now <ArrowRightIcon className="size-4"/>
                    </Link>

                    <Link to="/products" className="px-7 py-3 bg-white/10 text-white font-semibold 
                    rounded-full hover:bg-white/20 transition-all border border-white/20 "> Browse Categories 
                    </Link>
