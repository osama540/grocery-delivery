            ...
            <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
                ...
                <form onSubmit={handleSearch} className="hidden sm:flex flex-1 max-w-sm text-xs sm:text-sm">
                    <div className="relative w-full">
                        ...
                        className="w-full pl-8 pr-2 py-2 bg-orange-50 rounded-full ring ring-app-orange/15 focus:ring--app-orange/30"/>
                    </div>
                </form>
                ...
                <div className="flex items-center gap-3">
                    {/*Cart */}
                    <button className="relative p-2 round-x1" onClick={() => setIsCartOpen(true)}>
                    ...
                    <div className="relative">
                        ...
                        : (
                            <div className="flex-center gap-2">
                                <Link to='/login' className="hidden md:flex items-center gap-2 px-4 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-950-light transition-colors">
                            ...
                            <> 
                                ...
                                <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                                    ...
                                    <div onClick={() => setUserMenuOpen(false)}>
                                        ...
                                        {user && <Link to='/orders' className="dropdown-link"><PackageIcon size={16} /> My Order</Link>}
                                        ...
                                        {user?.isAdmin && (
                                            <Link to='/admin/products' className="dropdown-link"><ShieldIcon 
                                            className="text-app-orange-dark" size={16} /> <span
                                                className="text-app-orange-dark">Admin Panel
                                            </span></Link>
                                        )};
                                        {user && (
