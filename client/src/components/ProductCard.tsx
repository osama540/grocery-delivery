...
const ProductCard = ({product}: props) => {
  ...
  return (
    ...
    transiton-all duration-300 group animate-fade-in cursor-pointer"
    onClick={() => navigate(`/products/${product._id}`)}>
        ...
        <div className="relative aspect-square overflow-hidden">
            ...
            <div className="absolute top-3 left-3 flex flex-wrap gap-1.5">
                {product.discount > 0 &&
                <span className="px-2 py-0.5 text-[10px] font-semibold uppcase bg-app-orange text-white rounded-full">{product.discount}% OFF</span>}
            </div>
        </div>
        ...
        <div className="p-3.5 text-zinc-700">
            ...
            {product.discount > 0 &&(
                <div className="flex items-center gap-1 mb-2">
                    <Star className="size-3 text-app-warnig fill-app-waring"/>
            ...
            <div className="flex items-center justify-between">
                ...
                className="size-7 rounded-full bg-app-orange text-whit flex-center shrink-0 hover:bg-app-orange-dark transition-colors active:scale-95">
