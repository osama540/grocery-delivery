...
const Login = () => {
  ...
  return (
    ...
    <div className="hidden lg:flex lg:w-1/2 big-app-green relative items-center justify-center">
    <img src={heroSectionData.hero_image} alt="" className="absolute inset-0 object-cover h-full big-center opacity-50"/>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-app-text-light">
            ...
            <button onClick={() => setIsLoginState(!isLoginState)} className="text-organge-500 ml-1 font-semibold hover:text-orange-600 transition-colors">
