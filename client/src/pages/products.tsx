...
const Products =() => {
  ...
  return (
    <div className="min-h-screen bg-app-cream">
        ...
        <div className="flex gap-8 xl:gap-10">
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white rounded-2xl p-4 sticky top-24">
              ...
              <FilterPanel categories={categoriesData} category={category} organic={organic} minPrice={minPrice} maxPrice={maxPrice}
              updateFilter={updateFilter} clearFilters={clearFilters} hasFilters={hasFilter} />
              ...
              <div className="flex flex-col lg:items-center gap-3">
                <button onClick={()=> setMobileFiltersOpen(true)}
                  ...
                  <div className="relative">
                    ...
                    className="apparance-none pl-3 pr-8 py-2 text-sm bg-white rounded-xl border border-app-border focus:border-app-green outline-none cursor-pointer">
            ...
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt-16">
                {Array.from({length: totalPages}).map((_, i)=>(
                  ...
                  className={`size-9 rounded-lg text-sm font-medium transition-colors ${page === i + 1 ? "bg-app-green text-whitr" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
                    {i + 1}
                  </button>
                ))}
              </div>
      ...
      {mobileFiltersOpen && (
        <>
        <div className="fixed inset-0 bg-block/40 z-50" onClick={()=>
