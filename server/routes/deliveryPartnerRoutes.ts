...
import { cancelDelivery, completeDelivery, getDeliveryDelail, getMyDeliveries, loginPartner, updateDeliveryStatus, updateLocation } from "../controllers/deliveryPartnerController.js";
...
deliveryPartnerRouter.get('/my-deliveries/:id', deliveryAuth, getDeliveryDelail)
