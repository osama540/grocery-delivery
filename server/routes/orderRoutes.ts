...
import { createOrder, getAllOrder, getOrder, getOrderLocation, getUserOrder, updateOrderStatus, } from "../controllers/orderController.js";
...
orderRouter.get('/all', auth, admin, getAllOrder);
